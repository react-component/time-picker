...
function (_Component) {
  ...
  function Select() {
    ...
    _this.onSelect = function (value, e) {
  ...
  _createClass(Select, [{
    ...
    value: function getOptions() {
      ...
      return options.map(function (item, index) {
        ...
        var onClick = item.disabled ? undefined : function (e) {
          _this2.onSelect(item.value, e);
        };

        var onKeyDown = function onKeyDown(e) {
          if (e.keyCode === 13) onClick(e);else if (e.keyCode === 27) onEsc();
        };
